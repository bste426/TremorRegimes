...
def forecast_test():
    ...
    # window and look_forward currently in Minutes - can be changed in line 456/457/465 in __init__train.py
    fm = ForecastModel(ti='2012-08-03', tf='2012-08-05', window=10, overlap=5,
        look_forward=10, data_streams=data_streams, root='test') # forecast window in days
    ...
    # train the model
    #drop_features = ['linear_trend_timewise','agg_linear_trend']
    fm.train(ti='2012-08-03', tf='2012-08-05', retrain=True, n_jobs=n_jobs)
    print("done training")
    # plot a forecast for a future eruption
    #te = fm.data.tes[1]
    #fm.hires_forecast(ti=datetimeify('2012-08-08'), tf=datetimeify('2012-08-09'), save = None,
...
def forecast_now():
    ...
    td = TremorData()
    td.update(ti='2013-08-01', tf='2013-08-25')
    print("Done updating - now setting up model")
